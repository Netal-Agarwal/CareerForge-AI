      ...
      .catch((err) => {
        ...
        setError(
          err.response?.data?.detail ||
            "Could not load roadmap. Upload a resume first.",
        );
      })
    ...
    <div className="min-h-screen bg-slate-900">
      <div className="mx-auto max-w-4xl px-6 py-10">
        ...
        <p className="mt-2 text-slate-400">
          A step-by-step learning plan based on your skill gaps.
        </p>
        ...
        {loading && <p className="mt-8 text-slate-400">Loading roadmap...</p>}
          ...
          <div className="mt-8 space-y-8">
            {data.next_skill_to_learn && (
              <StatCard
                ...
                subtitle="Your highest-priority skill"
              />
            )}

            <section className="space-y-6">
              {[
                { label: "30 days", steps: data.roadmap?.["30_days"] },
                { label: "60 days", steps: data.roadmap?.["60_days"] },
                { label: "90 days", steps: data.roadmap?.["90_days"] },
              ].map(
                (phase) =>
                      ...
                      <div className="space-y-3">
                        {phase.steps.map((step, index) => (
                          <div
                            ...
                            className="rounded-xl border border-slate-700/60 bg-slate-800/50 px-5 py-4"
                          >
